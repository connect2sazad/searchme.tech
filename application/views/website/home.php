...
<!-- JQuery -->
    ...
    var user_id_login="<?=$this->security->xss_clean($this->session->userdata('searchme_login'));?>"
        $(document).ready(function(){
            ...
            var signup_btn_home="";
            if(user_id_login){
                signup_btn_home="<?=base_url('main/user_profile');?>";
                $("#signup_btn_home").text("My Profile");
            }else{
                signup_btn_home="<?=base_url('signup?s=0')?>";
            }

            $("#signup_btn_home").click(function() {
                window.location.href = signup_btn_home;
            });
