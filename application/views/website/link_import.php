<link rel = "icon" href ="<?=base_url('assets/images/srch_it_logo.svg');?>" sizes="any"  type = "image/svg+xml">     
    ...
    <link rel="stylesheet" href="<?=base_url();?>/assets/css/space-system.css?v=1.1"> 
    <link rel="stylesheet" href="<?=base_url();?>/assets/css/style-common.css?v=1.1"> 

    <link rel="stylesheet" href="<?=base_url();?>/assets/css/style-nav-footer.css?v=1.1"> 
